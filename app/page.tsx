...
import { FaGraduationCap, FaCertificate, FaBriefcase, FaLightbulb, FaUserAlt } from "react-icons/fa";
  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] text-muted-foreground md:text-xl">
                    I'm {" "}
                    <AnimatedText
                      texts={["Pursuing MCA", "a Web Developer", "a Android Developer"]}
        ...
        <section id="about" className="w-full py-20 bg-gradient-to-br from-[#0f172a] to-[#1e293b] text-white">
          <div className="container mx-auto px-6 md:px-12 lg:px-24">
            <div className="text-center mb-16">
              ...
              <p className="max-w-4xl text-lg text-gray-300 mt-4 mx-auto">
                I'm currently pursuing my MCA  Enthusiastic Full Stack Developer with internship experience in web
  ...
  <ul className="mt-4 text-gray-200 space-y-3 text-sm pl-2">
    ...
    <li>
      <a
        ...
        className="no-underline hover:text-yellow-500"
      >
        <strong>Job and Internship Training
</strong>
      </a>{" "}
      – <span className="text-teal-300">Internshala(2023)</span>
    </li>
              ...
              <div className="space-y-14">
                ...
                <div className="bg-gray-800 rounded-2xl shadow-xl p-6 border border-gray-700 transition hover:scale-[1.02] duration-300">
                  <h3 className="text-3xl font-bold mb-3 text-teal-400 text-center">Personal Info 🧾</h3>

                  <div className="space-y-3 text-sm md:text-base">

                    <div className="flex items-center gap-2"><MdEmail className="text-lg" /> <strong>Email:</strong> <span className="ml-auto">shoaib232002@gmail.com</span></div>
                    <div className="flex items-center gap-2"><MdPhone className="text-lg" /> <strong>Phone:</strong> <span className="ml-auto">+91 7892666933</span></div>
                    <div className="flex items-center gap-2"><MdLocationOn className="text-lg" /> <strong>Country:</strong> <span className="ml-auto">India</span></div>
                    <div className="flex items-center gap-2"><MdLocationCity className="text-lg" /> <strong>State:</strong> <span className="ml-auto">Karnataka</span></div>
                    <div className="flex items-center gap-2"><MdLocationCity className="text-lg" /> <strong>City:</strong> <span className="ml-auto">Bangalore</span></div>
                  </div>
                </div>
      ...
      <span className="text-teal-300">Frontend and backend development.</span>
                ...
                <div>
                  ...
                  <p className="text-gray-300 mt-2">
                    • Badminton 🎾 • Exploring Tech 💡 ⚙️ • Creative Coding 💻
                  </p>
                </div>
              </div>
            </div>
        ...
        <section id="projects" className="w-full py-12 md:py-24 lg:py-32">
          <div className="container px-4 md:px-6">
            ...
            <div className="mx-auto grid max-w-5xl items-center gap-6 py-12 md:grid-cols-2 lg:grid-cols-3">
              ...
              <ProjectCard
                title="FoodRunner"
                description="Built a user-side demo Android application focused on food ordering
 functionality with an intuitive and interactive UI."
      ...
      <footer className="w-full bg-[#0b0b0b] text-white px-8 py-12 border-t border-gray-800">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div>
            ...
            <div className="space-y-4 text-gray-400 text-sm">
              <a href="tel:+91 7892666933" className="flex items-center gap-3 no-underline text-inherit hover:opacity-80 transition">
        ...
        <div className="text-center space-y-1">
          <p className="text-sm font-medium text-white">Mohamed Shoaib & Mohamed Firose</p>
